# Mapa técnico para la futura redacción de tesis — M1.7
...
| GLV abierta en D y cierre dinámico | Santos .13/.15, mecánica .5.13; código Stage 2 | Estado y flujo heredados continuos; cierre a 28.5648265 s de D | NUMERICALLY_VERIFIED | Control de válvulas / continuidad de etapas |
| Correlación de caudal GLV | Santos p.33, .13/.15 | Diagnóstico de correlación fuente; producción aún hereda proxy de C→D | BLOCKED | Hipótesis, cierres constitutivos y limitaciones |
...
| .27 algebraica frente a .28 diferencial y fricción variable | Santos p.37–38 y sistema Tabla 5.1 | .28 literal; deriva algebraica máxima .27 de 4.043 kPa | BLOCKED | Cierres de momento / limitaciones metodológicas |
