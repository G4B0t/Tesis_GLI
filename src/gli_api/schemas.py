...
class SimulationInputs(BaseModel):
    ...
    staticReservoirPressure: float = Field(gt=0.0, default=85.2, description="kgf/cm2(g)")
    productivityIndex: float = Field(gt=0.0, default=1.0, description="m3/day/(kgf/cm2)")
